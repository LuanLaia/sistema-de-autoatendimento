        ...
        <div className="space-y-6 p-6">
            ...
            {orders.map(order => (
                 ...
                 <CardContent className="p-5 space-y-4">
                     <div className={`w-fit  rounded-full px-2 py-2 text-xs text-white font-semibold
                        ${order.status == OrderStatus.FINISHED ? "bg-green-500 text-white" : "bg-gray-100 text-gray-400"}
                        `}>
